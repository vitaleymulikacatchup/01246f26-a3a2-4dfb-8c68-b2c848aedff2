...
export const metadata: Metadata = {
  ...
  description: "Experience authentic Italian cuisine at Bella Vista. Traditional recipes, fresh ingredients, elegant atmosphere. Reserve your table today for an unforgettable dining experience.",
  keywords: "Italian restaurant, fine dining, authentic cuisine, reservations, pasta, seafood, dessert",
  metadataBase: new URL("https://bellavista.com"),
  alternates: {
    canonical: "https://bellavista.com"
  },
  openGraph: {
    title: "Bella Vista - Authentic Italian Fine Dining",
    description: "Experience the finest flavors of Italy with traditional recipes and fresh ingredients in an elegant atmosphere.",
  ...
  twitter: {
    ...
    title: "Bella Vista - Authentic Italian Fine Dining",
    description: "Experience the finest flavors of Italy with traditional recipes and fresh ingredients.",
